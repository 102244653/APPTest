...
//        Math.pow(double a ,double b) a的b次方
       ...
       TestLog.info("RandomNum: getNumRandom(lenght)",String.valueOf(num));
        return num;
    }
...
//       nextInt(2) 生成一个 [0,2) 之间的随机数
        ...
        TestLog.info("RandomNum: getNumRandom(min,max)",String.valueOf(num));
        return num;
    }
...
//            生成一个 [0,2) 之间的随机数
        ...
        TestLog.info("RandomNum: getStringRandom","生成随机数"+val);
        return val;
    }
}